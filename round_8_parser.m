function measurements = round_8_parser(TTC_path, type, file_no_1, file_no_2)
    ...
    % Load and append
    file_1 = load(strcat(TTC_path, '\round_8\RunData_', type, '_Matlab_SI_Round8\', round_8_id, 'run', file_no_1, '.mat'));
    file_2 = load(strcat(TTC_path, '\round_8\RunData_', type, '_Matlab_SI_Round8\', round_8_id, 'run', file_no_2, '.mat'));
