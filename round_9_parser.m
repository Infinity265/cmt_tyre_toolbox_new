function measurements = round_9_parser(TTC_path, type, file_no_1, file_no_2)
    ...
    % Load and append
    file_1 = load(strcat(TTC_path, '\round_9\RunData_', type, '_Matlab_SI_Round9\', round_9_id, 'run', file_no_1, '.mat'));
    file_2 = load(strcat(TTC_path, '\round_9\RunData_', type, '_Matlab_SI_Round9\', round_9_id, 'run', file_no_2, '.mat'));
